...
Docs site source lives in `docs-src/`. The changelog and provider matrix docs pages are generated by `pnpm docs:generate` from root/source files, so do not hand-edit `docs-src/src/content/docs/about/changelog.md` or `docs-src/src/content/docs/concepts/provider-matrix.md`. Generated extension locale metadata under `public/_locales/` comes from `src/locales/<lang>/translation.json`; do not hand-edit generated locale files.
