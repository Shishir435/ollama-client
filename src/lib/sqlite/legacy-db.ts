// The historical in-memory sql.js backend: the whole database lives in WASM
// memory and persists as one IndexedDB blob. Retired as the default by the
// OPFS single-owner backend (src/lib/persistence/); still used by profiles
