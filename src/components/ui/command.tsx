  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-8! bg-input/20 dark:bg-input/30">
        ...
        />
        <InputGroupAddon>
          <SearchIcon className="icon-sm shrink-0 opacity-50" />
        </InputGroupAddon>
      </InputGroup>
    </div>
  )
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-micro tracking-widest text-muted-foreground group-data-selected/command-item:text-foreground",
        className
      )}
      {...props}
    />
