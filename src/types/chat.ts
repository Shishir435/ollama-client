...
export interface ActivityText {
  /** Stored fallback or user/provider text. */
  text: string
  /** Present only when `text` was generated by the app. */
  textKey?: string
}
...
export interface ActivityEvent {
  ...
  finishedAt?: number
  inputPreview?: string
  outputPreview?: string | ActivityText
  resultCount?: number
  sourceTitles?: Array<string | ActivityText>
  error?: string
}
