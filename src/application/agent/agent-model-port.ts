...
extract asks up to six find queries in one pass: {"type":"extract","queries":["price","SKU","in stock"]}. The answer comes back as lookup, one group per query in the order asked, each naming the refs that matched. An empty group means the page holds no such control, which is an answer. A group marked truncated had more; narrow it with find.
