  ...
  return (TesseractCore = {}) => {
    ...
    function Pa(a, c) {
      ...
      return pa ||
        ...
        : fetch(d, { credentials: "same-origin" }).then((e) =>
            WebAssembly.instantiateStreaming(e, a).then(c, (g) => {
      ...
      B = {
            ...
            (B.Vf = {
              dir: {
                node: {
                  ...
                  unlink: B.Ef.unlink,
                  rmdir: B.Ef.rmdir,
                  readdir: B.Ef.readdir,
                  symlink: B.Ef.symlink
                },
                stream: { Tf: B.Gf.Tf }
              },
              file: {
                node: { Sf: B.Ef.Sf, Of: B.Ef.Of },
                stream: {
                  Tf: B.Gf.Tf,
                  read: B.Gf.read,
                  write: B.Gf.write,
              ...
              link: {
                node: { Sf: B.Ef.Sf, Of: B.Ef.Of, readlink: B.Ef.readlink },
                stream: {}
              },
              $g: { node: { Sf: B.Ef.Sf, Of: B.Ef.Of }, stream: A.Ah }
            })
          d = A.createNode(a, c, d, e)
          A.Nf(d.mode)
            ? ((d.Ef = B.Vf.dir.node), (d.Gf = B.Vf.dir.stream), (d.Ff = {}))
            : A.isFile(d.mode)
              ? ((d.Ef = B.Vf.file.node),
                (d.Gf = B.Vf.file.stream),
                (d.Kf = 0),
                (d.Ff = null))
              : A.qg(d.mode)
                ? ((d.Ef = B.Vf.link.node), (d.Gf = B.Vf.link.stream))
                : A.vg(d.mode) &&
                  ((d.Ef = B.Vf.$g.node), (d.Gf = B.Vf.$g.stream))
        ...
        hh: (a, c) => {
          ...
          d >= c ||
            ...
            0 < a.Kf && a.Ff.set(d.subarray(0, a.Kf), 0))
        },
        ni: (a, c) => {
          if (a.Kf != c)
            if (0 == c) (a.Ff = null), (a.Kf = 0)
            else {
              var d = a.Ff
              a.Ff = new Uint8Array(c)
        ...
        Ef: {
          ...
          Zf: (a, c, d, e) => B.createNode(a, c, d, e),
          rename: (a, c, d) => {
            if (A.Nf(a.mode)) {
              try {
                var e = A.Yf(c, d)
          ...
          readdir: (a) => {
            var c = [".", ".."],
              d
            for (d in a.Ff) Object.hasOwn(a.Ff, d) && c.push(d)
            return c
          },
          symlink: (a, c, d) => {
        ...
        Gf: {
          ...
          write: (a, c, d, e, g, h) => {
            ...
            if (c.subarray && (!a.Ff || a.Ff.subarray)) {
              ...
              if (0 === a.Kf && 0 === g)
                return (a.Ff = c.slice(d, d + e)), (a.Kf = e)
              if (g + e <= a.Kf) return a.Ff.set(c.subarray(d, d + e), g), e
            }
            B.hh(a, g + e)
            if (a.Ff.subarray && c.subarray) a.Ff.set(c.subarray(d, d + e), g)
          ...
          Tf: (a, c, d) => {
            1 === d
              ? (c += a.position)
              : 2 === d && A.isFile(a.node.mode) && (c += a.node.Kf)
    ...
    var A = {
      ...
      Yf: (a, c) => {
        ...
        for (d = A.Uf[A.Ng(a.id, c)]; d; d = d.gg) {
          var e = d.name
      ...
      dh: (a, c, d) => {
        A.tg ||
          ...
          (A.tg.prototype = {}),
          Object.defineProperties(A.tg.prototype, {
            object: {
              get: function () {
                return this.node
              },
      ...
      lookup: (a, c) => a.Ef.lookup(a, c),
      Zf: (a, c, d) => {
        var e = A.Jf(a, { parent: !0 }).node
        a = eb(a)
      ...
      create: (a, c) => A.Zf(a, ((void 0 !== c ? c : 438) & 4095) | 32768, 0),
      mkdir: (a, c) => A.Zf(a, ((void 0 !== c ? c : 511) & 1023) | 16384, 0),
      Ai: (a, c) => {
        a = a.split("/")
      ...
      truncate: (a, c) => {
        if (0 > c) throw new A.Df(28)
        a = "string" == typeof a ? A.Jf(a, { Rf: !0 }).node : a
        if (!a.Ef.Of) throw new A.Df(63)
      ...
      lg: (a, c, d, e, g) => (a.Gf.lg ? a.Gf.lg(a, c, d, e, g) : 0),
      Bi: () => 0,
      Pg: (a, c, d) => {
      ...
      writeFile: (a, c, d = {}) => {
        ...
        if ("string" == typeof c) {
          ...
          A.write(a, c, 0, c.byteLength, void 0, d.zh)
      ...
      Gh: () => {
        b.stdin
          ? A.Qf("/dev", "stdin", b.stdin)
          : A.symlink("/dev/tty", "/dev/stdin")
        b.stdout
          ? A.Qf("/dev", "stdout", null, b.stdout)
          : A.symlink("/dev/tty", "/dev/stdout")
        b.stderr
          ? A.Qf("/dev", "stderr", null, b.stderr)
      ...
      gh: () => {
        A.Df ||
          ...
          (A.Df.prototype = Error()),
          (A.Df.prototype.constructor = A.Df),
          [44].forEach((a) => {
            A.Hg[a] = new A.Df(a)
      ...
      Gg: (a) => {
        if (a.Qg || a.fi || a.link || a.Ff) return !0
        ...
        if (ja)
          try {
            ;(a.Ff = kb(ja(a.url), !0)), (a.Kf = a.Ff.length)
          } catch (c) {
            throw new A.Df(29)
          }
      ...
      ah: (a, c, d, e, g) => {
        ...
        h.prototype.Zg = function () {
          ...
          this.Cg((E) => {
            ...
            if ("undefined" == typeof this.Pf[E]) throw Error("doXHR failed!")
            return this.Pf[E]
          })
          if (q || !t)
            (l = t = 1),
              (l = t = this.lh(0).length),
              na(
    ...
    function Nb(a, c, d, e) {
      ...
      q = {
        "%a": (l) => F[l.Wf].substring(0, 3),
        "%A": (l) => F[l.Wf],
        "%b": (l) => U[l.Bg].substring(0, 3),
        "%B": (l) => U[l.Bg],
        "%C": (l) => h(((l.kg + 1900) / 100) | 0, 2),
        "%d": (l) => h(l.Yg, 2),
        "%e": (l) => g(l.Yg, 2, " "),
        "%g": (l) => v(l).toString().substring(2),
        "%G": (l) => v(l),
        "%H": (l) => h(l.Ag, 2),
        "%I": (l) => {
          l = l.Ag
        ...
        "%M": (l) => h(l.si, 2),
        "%n": () => "\n",
        "%p": (l) => (0 <= l.Ag && 12 > l.Ag ? "AM" : "PM"),
        "%S": (l) => h(l.ti, 2),
        "%t": () => "\t",
        "%u": (l) => l.Wf || 7,
        "%U": (l) => h(Math.floor((l.jg + 7 - l.Wf) / 7), 2),
        "%V": (l) => {
        ...
        "%w": (l) => l.Wf,
        "%W": (l) => h(Math.floor((l.jg + 7 - ((l.Wf + 6) % 7)) / 7), 2),
        "%y": (l) => (l.kg + 1900).toString().substring(2),
        "%Y": (l) => l.kg + 1900,
        "%z": (l) => {
          l = l.ri
          var w = 0 <= l
      ...
      for (t in q) d.includes(t) && (d = d.replace(new RegExp(t, "g"), q[t](e)))
      d = d.replace(/\0\0/g, "%")
      t = kb(d, !1)
    ...
    var cc = {
      ...
      S: (a) => {
        do {
          ...
          c = z(c)
          A.Dg("/", db(c), !0, !0)
          A.ug(c, null, p.subarray(e, e + d), !0, !0, !0)
        } while (u[a >> 2])
      },
      P: () => !0,
      y: () => {
    ...
    var dc = (b._emscripten_bind_ParagraphJustification___destroy___0 = () =>
        (dc = b._emscripten_bind_ParagraphJustification___destroy___0 =
          b.asm.W).apply(null, arguments)),
      ec = (b._emscripten_bind_BoolPtr___destroy___0 = () =>
        (ec = b._emscripten_bind_BoolPtr___destroy___0 = b.asm.X).apply(
          null,
          arguments
        )),
      ...
      gc = (b._emscripten_bind_TessResultRenderer_AddImage_1 = () =>
        (gc = b._emscripten_bind_TessResultRenderer_AddImage_1 = b.asm.Z).apply(
          null,
          arguments
        )),
      hc = (b._emscripten_bind_TessResultRenderer_EndDocument_0 = () =>
        (hc = b._emscripten_bind_TessResultRenderer_EndDocument_0 =
          b.asm._).apply(null, arguments)),
      ic = (b._emscripten_bind_TessResultRenderer_happy_0 = () =>
        (ic = b._emscripten_bind_TessResultRenderer_happy_0 = b.asm.$).apply(
          null,
          arguments
        )),
      ...
      kc = (b._emscripten_bind_TessResultRenderer_title_0 = () =>
        (kc = b._emscripten_bind_TessResultRenderer_title_0 = b.asm.ba).apply(
          null,
          arguments
        )),
      lc = (b._emscripten_bind_TessResultRenderer_imagenum_0 = () =>
        (lc = b._emscripten_bind_TessResultRenderer_imagenum_0 =
          b.asm.ca).apply(null, arguments)),
      mc = (b._emscripten_bind_TessResultRenderer___destroy___0 = () =>
        (mc = b._emscripten_bind_TessResultRenderer___destroy___0 =
          b.asm.da).apply(null, arguments)),
      nc = (b._emscripten_bind_LongStarPtr___destroy___0 = () =>
        (nc = b._emscripten_bind_LongStarPtr___destroy___0 = b.asm.ea).apply(
          null,
          arguments
        )),
      oc = (b._emscripten_bind_VoidPtr___destroy___0 = () =>
        (oc = b._emscripten_bind_VoidPtr___destroy___0 = b.asm.fa).apply(
          null,
          arguments
        )),
      pc = (b._emscripten_bind_ResultIterator_ResultIterator_1 = () =>
        (pc = b._emscripten_bind_ResultIterator_ResultIterator_1 =
          b.asm.ga).apply(null, arguments)),
      qc = (b._emscripten_bind_ResultIterator_Begin_0 = () =>
        (qc = b._emscripten_bind_ResultIterator_Begin_0 = b.asm.ha).apply(
          null,
          arguments
        )),
      rc = (b._emscripten_bind_ResultIterator_RestartParagraph_0 = () =>
        (rc = b._emscripten_bind_ResultIterator_RestartParagraph_0 =
      ...
      tc = (b._emscripten_bind_ResultIterator_RestartRow_0 = () =>
        (tc = b._emscripten_bind_ResultIterator_RestartRow_0 = b.asm.ka).apply(
          null,
          arguments
        )),
      uc = (b._emscripten_bind_ResultIterator_Next_1 = () =>
        (uc = b._emscripten_bind_ResultIterator_Next_1 = b.asm.la).apply(
          null,
          arguments
        )),
      ...
      wc = (b._emscripten_bind_ResultIterator_IsAtFinalElement_2 = () =>
        (wc = b._emscripten_bind_ResultIterator_IsAtFinalElement_2 =
          b.asm.na).apply(null, arguments)),
      xc = (b._emscripten_bind_ResultIterator_Cmp_1 = () =>
        (xc = b._emscripten_bind_ResultIterator_Cmp_1 = b.asm.oa).apply(
          null,
          arguments
        )),
      ...
      zc = (b._emscripten_bind_ResultIterator_BoundingBox_5 = () =>
        (zc = b._emscripten_bind_ResultIterator_BoundingBox_5 = b.asm.qa).apply(
          null,
          arguments
        )),
      Ac = (b._emscripten_bind_ResultIterator_BoundingBox_6 = () =>
        (Ac = b._emscripten_bind_ResultIterator_BoundingBox_6 = b.asm.ra).apply(
          null,
          arguments
        )),
      ...
      Cc = (b._emscripten_bind_ResultIterator_Empty_1 = () =>
        (Cc = b._emscripten_bind_ResultIterator_Empty_1 = b.asm.ta).apply(
          null,
          arguments
        )),
      Dc = (b._emscripten_bind_ResultIterator_BlockType_0 = () =>
        (Dc = b._emscripten_bind_ResultIterator_BlockType_0 = b.asm.ua).apply(
          null,
          arguments
        )),
      ...
      Fc = (b._emscripten_bind_ResultIterator_GetBinaryImage_1 = () =>
        (Fc = b._emscripten_bind_ResultIterator_GetBinaryImage_1 =
          b.asm.wa).apply(null, arguments)),
      Gc = (b._emscripten_bind_ResultIterator_GetImage_5 = () =>
        (Gc = b._emscripten_bind_ResultIterator_GetImage_5 = b.asm.xa).apply(
          null,
          arguments
        )),
      Hc = (b._emscripten_bind_ResultIterator_Baseline_5 = () =>
        (Hc = b._emscripten_bind_ResultIterator_Baseline_5 = b.asm.ya).apply(
          null,
          arguments
        )),
      Ic = (b._emscripten_bind_ResultIterator_RowAttributes_3 = () =>
        (Ic = b._emscripten_bind_ResultIterator_RowAttributes_3 =
          b.asm.za).apply(null, arguments)),
      Jc = (b._emscripten_bind_ResultIterator_Orientation_4 = () =>
        (Jc = b._emscripten_bind_ResultIterator_Orientation_4 = b.asm.Aa).apply(
          null,
          arguments
        )),
      ...
      Lc = (b._emscripten_bind_ResultIterator_ParagraphIsLtr_0 = () =>
        (Lc = b._emscripten_bind_ResultIterator_ParagraphIsLtr_0 =
          b.asm.Ca).apply(null, arguments)),
      Mc = (b._emscripten_bind_ResultIterator_GetUTF8Text_1 = () =>
        (Mc = b._emscripten_bind_ResultIterator_GetUTF8Text_1 = b.asm.Da).apply(
          null,
          arguments
        )),
      ...
      Pc = (b._emscripten_bind_ResultIterator_Confidence_1 = () =>
        (Pc = b._emscripten_bind_ResultIterator_Confidence_1 = b.asm.Ga).apply(
          null,
          arguments
        )),
      ...
      Uc = (b._emscripten_bind_ResultIterator_WordIsNumeric_0 = () =>
        (Uc = b._emscripten_bind_ResultIterator_WordIsNumeric_0 =
          b.asm.La).apply(null, arguments)),
      Vc = (b._emscripten_bind_ResultIterator_HasBlamerInfo_0 = () =>
        (Vc = b._emscripten_bind_ResultIterator_HasBlamerInfo_0 =
          b.asm.Ma).apply(null, arguments)),
      ...
      $c = (b._emscripten_bind_ResultIterator_WordLattice_1 = () =>
        ($c = b._emscripten_bind_ResultIterator_WordLattice_1 = b.asm.Ra).apply(
          null,
          arguments
        )),
      ...
      dd = (b._emscripten_bind_ResultIterator___destroy___0 = () =>
        (dd = b._emscripten_bind_ResultIterator___destroy___0 = b.asm.Va).apply(
          null,
          arguments
        )),
      ed = (b._emscripten_bind_TextlineOrder___destroy___0 = () =>
        (ed = b._emscripten_bind_TextlineOrder___destroy___0 = b.asm.Wa).apply(
          null,
          arguments
        )),
      fd = (b._emscripten_bind_ETEXT_DESC___destroy___0 = () =>
        (fd = b._emscripten_bind_ETEXT_DESC___destroy___0 = b.asm.Xa).apply(
          null,
          arguments
        )),
      gd = (b._emscripten_bind_PageIterator_Begin_0 = () =>
        (gd = b._emscripten_bind_PageIterator_Begin_0 = b.asm.Ya).apply(
          null,
          arguments
        )),
      ...
      kd = (b._emscripten_bind_PageIterator_RestartRow_0 = () =>
        (kd = b._emscripten_bind_PageIterator_RestartRow_0 = b.asm.$a).apply(
          null,
          arguments
        )),
      ld = (b._emscripten_bind_PageIterator_Next_1 = () =>
        (ld = b._emscripten_bind_PageIterator_Next_1 = b.asm.ab).apply(
          null,
          arguments
        )),
      md = (b._emscripten_bind_PageIterator_IsAtBeginningOf_1 = () =>
        (md = b._emscripten_bind_PageIterator_IsAtBeginningOf_1 =
          b.asm.bb).apply(null, arguments)),
      nd = (b._emscripten_bind_PageIterator_IsAtFinalElement_2 = () =>
        (nd = b._emscripten_bind_PageIterator_IsAtFinalElement_2 =
          b.asm.cb).apply(null, arguments)),
      od = (b._emscripten_bind_PageIterator_Cmp_1 = () =>
        (od = b._emscripten_bind_PageIterator_Cmp_1 = b.asm.db).apply(
          null,
          arguments
        )),
      ...
      qd = (b._emscripten_bind_PageIterator_BoundingBox_5 = () =>
        (qd = b._emscripten_bind_PageIterator_BoundingBox_5 = b.asm.fb).apply(
          null,
          arguments
        )),
      rd = (b._emscripten_bind_PageIterator_BoundingBox_6 = () =>
        (rd = b._emscripten_bind_PageIterator_BoundingBox_6 = b.asm.gb).apply(
          null,
          arguments
        )),
      ...
      td = (b._emscripten_bind_PageIterator_Empty_1 = () =>
        (td = b._emscripten_bind_PageIterator_Empty_1 = b.asm.ib).apply(
          null,
          arguments
        )),
      ud = (b._emscripten_bind_PageIterator_BlockType_0 = () =>
        (ud = b._emscripten_bind_PageIterator_BlockType_0 = b.asm.jb).apply(
          null,
          arguments
        )),
      vd = (b._emscripten_bind_PageIterator_BlockPolygon_0 = () =>
        (vd = b._emscripten_bind_PageIterator_BlockPolygon_0 = b.asm.kb).apply(
          null,
          arguments
        )),
      ...
      xd = (b._emscripten_bind_PageIterator_GetImage_5 = () =>
        (xd = b._emscripten_bind_PageIterator_GetImage_5 = b.asm.mb).apply(
          null,
          arguments
        )),
      yd = (b._emscripten_bind_PageIterator_Baseline_5 = () =>
        (yd = b._emscripten_bind_PageIterator_Baseline_5 = b.asm.nb).apply(
          null,
          arguments
        )),
      zd = (b._emscripten_bind_PageIterator_Orientation_4 = () =>
        (zd = b._emscripten_bind_PageIterator_Orientation_4 = b.asm.ob).apply(
          null,
          arguments
        )),
      Ad = (b._emscripten_bind_PageIterator_ParagraphInfo_4 = () =>
        (Ad = b._emscripten_bind_PageIterator_ParagraphInfo_4 = b.asm.pb).apply(
          null,
          arguments
        )),
      Bd = (b._emscripten_bind_PageIterator___destroy___0 = () =>
        (Bd = b._emscripten_bind_PageIterator___destroy___0 = b.asm.qb).apply(
          null,
          arguments
        )),
      Cd = (b._emscripten_bind_WritingDirection___destroy___0 = () =>
        (Cd = b._emscripten_bind_WritingDirection___destroy___0 =
          b.asm.rb).apply(null, arguments)),
      Dd = (b._emscripten_bind_WordChoiceIterator_WordChoiceIterator_1 = () =>
        (Dd = b._emscripten_bind_WordChoiceIterator_WordChoiceIterator_1 =
          b.asm.sb).apply(null, arguments)),
      Ed = (b._emscripten_bind_WordChoiceIterator_Next_0 = () =>
        (Ed = b._emscripten_bind_WordChoiceIterator_Next_0 = b.asm.tb).apply(
          null,
          arguments
        )),
      ...
      Gd = (b._emscripten_bind_WordChoiceIterator_Confidence_0 = () =>
        (Gd = b._emscripten_bind_WordChoiceIterator_Confidence_0 =
      ...
      Id = (b._emscripten_bind_Box_get_x_0 = () =>
        (Id = b._emscripten_bind_Box_get_x_0 = b.asm.xb).apply(
          null,
          arguments
        )),
      Jd = (b._emscripten_bind_Box_get_y_0 = () =>
        (Jd = b._emscripten_bind_Box_get_y_0 = b.asm.yb).apply(
          null,
          arguments
        )),
      Kd = (b._emscripten_bind_Box_get_w_0 = () =>
        (Kd = b._emscripten_bind_Box_get_w_0 = b.asm.zb).apply(
          null,
          arguments
        )),
      Ld = (b._emscripten_bind_Box_get_h_0 = () =>
        (Ld = b._emscripten_bind_Box_get_h_0 = b.asm.Ab).apply(
          null,
          arguments
        )),
      Md = (b._emscripten_bind_Box_get_refcount_0 = () =>
        (Md = b._emscripten_bind_Box_get_refcount_0 = b.asm.Bb).apply(
          null,
          arguments
        )),
      Nd = (b._emscripten_bind_Box___destroy___0 = () =>
        (Nd = b._emscripten_bind_Box___destroy___0 = b.asm.Cb).apply(
          null,
          arguments
        )),
      ...
      Pd = (b._emscripten_bind_TessPDFRenderer_BeginDocument_1 = () =>
        (Pd = b._emscripten_bind_TessPDFRenderer_BeginDocument_1 =
          b.asm.Eb).apply(null, arguments)),
      Qd = (b._emscripten_bind_TessPDFRenderer_AddImage_1 = () =>
        (Qd = b._emscripten_bind_TessPDFRenderer_AddImage_1 = b.asm.Fb).apply(
          null,
          arguments
        )),
      ...
      Sd = (b._emscripten_bind_TessPDFRenderer_happy_0 = () =>
        (Sd = b._emscripten_bind_TessPDFRenderer_happy_0 = b.asm.Hb).apply(
          null,
          arguments
        )),
      ...
      Ud = (b._emscripten_bind_TessPDFRenderer_title_0 = () =>
        (Ud = b._emscripten_bind_TessPDFRenderer_title_0 = b.asm.Jb).apply(
          null,
          arguments
        )),
      Vd = (b._emscripten_bind_TessPDFRenderer_imagenum_0 = () =>
        (Vd = b._emscripten_bind_TessPDFRenderer_imagenum_0 = b.asm.Kb).apply(
          null,
          arguments
        )),
      Wd = (b._emscripten_bind_TessPDFRenderer___destroy___0 = () =>
        (Wd = b._emscripten_bind_TessPDFRenderer___destroy___0 =
          b.asm.Lb).apply(null, arguments)),
      Xd = (b._emscripten_bind_PixaPtr___destroy___0 = () =>
        (Xd = b._emscripten_bind_PixaPtr___destroy___0 = b.asm.Mb).apply(
          null,
          arguments
        )),
      Yd = (b._emscripten_bind_FloatPtr___destroy___0 = () =>
        (Yd = b._emscripten_bind_FloatPtr___destroy___0 = b.asm.Nb).apply(
          null,
          arguments
        )),
      ...
      $d = (b._emscripten_bind_ChoiceIterator_Next_0 = () =>
        ($d = b._emscripten_bind_ChoiceIterator_Next_0 = b.asm.Pb).apply(
          null,
          arguments
        )),
      ae = (b._emscripten_bind_ChoiceIterator_GetUTF8Text_0 = () =>
        (ae = b._emscripten_bind_ChoiceIterator_GetUTF8Text_0 = b.asm.Qb).apply(
          null,
          arguments
        )),
      be = (b._emscripten_bind_ChoiceIterator_Confidence_0 = () =>
        (be = b._emscripten_bind_ChoiceIterator_Confidence_0 = b.asm.Rb).apply(
          null,
          arguments
        )),
      ce = (b._emscripten_bind_ChoiceIterator___destroy___0 = () =>
        (ce = b._emscripten_bind_ChoiceIterator___destroy___0 = b.asm.Sb).apply(
          null,
          arguments
        )),
      de = (b._emscripten_bind_PixPtr___destroy___0 = () =>
        (de = b._emscripten_bind_PixPtr___destroy___0 = b.asm.Tb).apply(
          null,
          arguments
        )),
      ...
      he = (b._emscripten_bind_UNICHARSET___destroy___0 = () =>
        (he = b._emscripten_bind_UNICHARSET___destroy___0 = b.asm.Xb).apply(
          null,
          arguments
        )),
      ie = (b._emscripten_bind_IntPtr___destroy___0 = () =>
        (ie = b._emscripten_bind_IntPtr___destroy___0 = b.asm.Yb).apply(
          null,
          arguments
        )),
      je = (b._emscripten_bind_Orientation___destroy___0 = () =>
        (je = b._emscripten_bind_Orientation___destroy___0 = b.asm.Zb).apply(
          null,
          arguments
        )),
      ...
      le = (b._emscripten_bind_OSBestResult_get_script_id_0 = () =>
        (le = b._emscripten_bind_OSBestResult_get_script_id_0 = b.asm.$b).apply(
          null,
          arguments
        )),
      ...
      oe = (b._emscripten_bind_OSBestResult___destroy___0 = () =>
        (oe = b._emscripten_bind_OSBestResult___destroy___0 = b.asm.cc).apply(
          null,
          arguments
        )),
      pe = (b._emscripten_bind_Boxa_get_n_0 = () =>
        (pe = b._emscripten_bind_Boxa_get_n_0 = b.asm.dc).apply(
          null,
          arguments
        )),
      qe = (b._emscripten_bind_Boxa_get_nalloc_0 = () =>
        (qe = b._emscripten_bind_Boxa_get_nalloc_0 = b.asm.ec).apply(
          null,
          arguments
        )),
      re = (b._emscripten_bind_Boxa_get_refcount_0 = () =>
        (re = b._emscripten_bind_Boxa_get_refcount_0 = b.asm.fc).apply(
          null,
          arguments
        )),
      se = (b._emscripten_bind_Boxa_get_box_0 = () =>
        (se = b._emscripten_bind_Boxa_get_box_0 = b.asm.gc).apply(
          null,
          arguments
        )),
      te = (b._emscripten_bind_Boxa___destroy___0 = () =>
        (te = b._emscripten_bind_Boxa___destroy___0 = b.asm.hc).apply(
          null,
          arguments
        )),
      ue = (b._emscripten_bind_PixColormap_get_array_0 = () =>
        (ue = b._emscripten_bind_PixColormap_get_array_0 = b.asm.ic).apply(
          null,
          arguments
        )),
      ve = (b._emscripten_bind_PixColormap_get_depth_0 = () =>
        (ve = b._emscripten_bind_PixColormap_get_depth_0 = b.asm.jc).apply(
          null,
          arguments
        )),
      we = (b._emscripten_bind_PixColormap_get_nalloc_0 = () =>
        (we = b._emscripten_bind_PixColormap_get_nalloc_0 = b.asm.kc).apply(
          null,
          arguments
        )),
      xe = (b._emscripten_bind_PixColormap_get_n_0 = () =>
        (xe = b._emscripten_bind_PixColormap_get_n_0 = b.asm.lc).apply(
          null,
          arguments
        )),
      ye = (b._emscripten_bind_PixColormap___destroy___0 = () =>
        (ye = b._emscripten_bind_PixColormap___destroy___0 = b.asm.mc).apply(
          null,
          arguments
        )),
      ze = (b._emscripten_bind_Pta_get_n_0 = () =>
        (ze = b._emscripten_bind_Pta_get_n_0 = b.asm.nc).apply(
          null,
          arguments
        )),
      Ae = (b._emscripten_bind_Pta_get_nalloc_0 = () =>
        (Ae = b._emscripten_bind_Pta_get_nalloc_0 = b.asm.oc).apply(
          null,
          arguments
        )),
      Be = (b._emscripten_bind_Pta_get_refcount_0 = () =>
        (Be = b._emscripten_bind_Pta_get_refcount_0 = b.asm.pc).apply(
          null,
          arguments
        )),
      Ce = (b._emscripten_bind_Pta_get_x_0 = () =>
        (Ce = b._emscripten_bind_Pta_get_x_0 = b.asm.qc).apply(
          null,
          arguments
        )),
      De = (b._emscripten_bind_Pta_get_y_0 = () =>
        (De = b._emscripten_bind_Pta_get_y_0 = b.asm.rc).apply(
          null,
          arguments
        )),
      Ee = (b._emscripten_bind_Pta___destroy___0 = () =>
        (Ee = b._emscripten_bind_Pta___destroy___0 = b.asm.sc).apply(
          null,
          arguments
        )),
      Fe = (b._emscripten_bind_Pix_get_w_0 = () =>
        (Fe = b._emscripten_bind_Pix_get_w_0 = b.asm.tc).apply(
          null,
          arguments
        )),
      Ge = (b._emscripten_bind_Pix_get_h_0 = () =>
        (Ge = b._emscripten_bind_Pix_get_h_0 = b.asm.uc).apply(
          null,
          arguments
        )),
      He = (b._emscripten_bind_Pix_get_d_0 = () =>
        (He = b._emscripten_bind_Pix_get_d_0 = b.asm.vc).apply(
          null,
          arguments
        )),
      Ie = (b._emscripten_bind_Pix_get_spp_0 = () =>
        (Ie = b._emscripten_bind_Pix_get_spp_0 = b.asm.wc).apply(
          null,
          arguments
        )),
      Je = (b._emscripten_bind_Pix_get_wpl_0 = () =>
        (Je = b._emscripten_bind_Pix_get_wpl_0 = b.asm.xc).apply(
          null,
          arguments
        )),
      Ke = (b._emscripten_bind_Pix_get_refcount_0 = () =>
        (Ke = b._emscripten_bind_Pix_get_refcount_0 = b.asm.yc).apply(
          null,
          arguments
        )),
      Le = (b._emscripten_bind_Pix_get_xres_0 = () =>
        (Le = b._emscripten_bind_Pix_get_xres_0 = b.asm.zc).apply(
          null,
          arguments
        )),
      Me = (b._emscripten_bind_Pix_get_yres_0 = () =>
        (Me = b._emscripten_bind_Pix_get_yres_0 = b.asm.Ac).apply(
          null,
          arguments
        )),
      Ne = (b._emscripten_bind_Pix_get_informat_0 = () =>
        (Ne = b._emscripten_bind_Pix_get_informat_0 = b.asm.Bc).apply(
          null,
          arguments
        )),
      Oe = (b._emscripten_bind_Pix_get_special_0 = () =>
        (Oe = b._emscripten_bind_Pix_get_special_0 = b.asm.Cc).apply(
          null,
          arguments
        )),
      Pe = (b._emscripten_bind_Pix_get_text_0 = () =>
        (Pe = b._emscripten_bind_Pix_get_text_0 = b.asm.Dc).apply(
          null,
          arguments
        )),
      Qe = (b._emscripten_bind_Pix_get_colormap_0 = () =>
        (Qe = b._emscripten_bind_Pix_get_colormap_0 = b.asm.Ec).apply(
          null,
          arguments
        )),
      Re = (b._emscripten_bind_Pix_get_data_0 = () =>
        (Re = b._emscripten_bind_Pix_get_data_0 = b.asm.Fc).apply(
          null,
          arguments
        )),
      Se = (b._emscripten_bind_Pix___destroy___0 = () =>
        (Se = b._emscripten_bind_Pix___destroy___0 = b.asm.Gc).apply(
          null,
          arguments
        )),
      Te = (b._emscripten_bind_DoublePtr___destroy___0 = () =>
        (Te = b._emscripten_bind_DoublePtr___destroy___0 = b.asm.Hc).apply(
          null,
          arguments
        )),
      Ue = (b._emscripten_bind_Dawg___destroy___0 = () =>
        (Ue = b._emscripten_bind_Dawg___destroy___0 = b.asm.Ic).apply(
          null,
          arguments
        )),
      Ve = (b._emscripten_bind_BoxPtr___destroy___0 = () =>
        (Ve = b._emscripten_bind_BoxPtr___destroy___0 = b.asm.Jc).apply(
          null,
          arguments
        )),
      We = (b._emscripten_bind_TessBaseAPI_TessBaseAPI_0 = () =>
        (We = b._emscripten_bind_TessBaseAPI_TessBaseAPI_0 = b.asm.Kc).apply(
          null,
          arguments
        )),
      Xe = (b._emscripten_bind_TessBaseAPI_Version_0 = () =>
        (Xe = b._emscripten_bind_TessBaseAPI_Version_0 = b.asm.Lc).apply(
          null,
          arguments
        )),
      Ye = (b._emscripten_bind_TessBaseAPI_SetInputName_1 = () =>
        (Ye = b._emscripten_bind_TessBaseAPI_SetInputName_1 = b.asm.Mc).apply(
          null,
          arguments
        )),
      Ze = (b._emscripten_bind_TessBaseAPI_GetInputName_0 = () =>
        (Ze = b._emscripten_bind_TessBaseAPI_GetInputName_0 = b.asm.Nc).apply(
          null,
          arguments
        )),
      $e = (b._emscripten_bind_TessBaseAPI_SetInputImage_1 = () =>
        ($e = b._emscripten_bind_TessBaseAPI_SetInputImage_1 = b.asm.Oc).apply(
          null,
          arguments
        )),
      af = (b._emscripten_bind_TessBaseAPI_GetInputImage_0 = () =>
        (af = b._emscripten_bind_TessBaseAPI_GetInputImage_0 = b.asm.Pc).apply(
          null,
          arguments
        )),
      ...
      cf = (b._emscripten_bind_TessBaseAPI_GetDatapath_0 = () =>
        (cf = b._emscripten_bind_TessBaseAPI_GetDatapath_0 = b.asm.Rc).apply(
          null,
          arguments
        )),
      df = (b._emscripten_bind_TessBaseAPI_SetOutputName_1 = () =>
        (df = b._emscripten_bind_TessBaseAPI_SetOutputName_1 = b.asm.Sc).apply(
          null,
          arguments
        )),
      ef = (b._emscripten_bind_TessBaseAPI_SetVariable_2 = () =>
        (ef = b._emscripten_bind_TessBaseAPI_SetVariable_2 = b.asm.Tc).apply(
          null,
          arguments
        )),
      ...
      gf = (b._emscripten_bind_TessBaseAPI_GetIntVariable_2 = () =>
        (gf = b._emscripten_bind_TessBaseAPI_GetIntVariable_2 = b.asm.Vc).apply(
          null,
          arguments
        )),
      ...
      jf = (b._emscripten_bind_TessBaseAPI_GetDoubleVariable_2 = () =>
        (jf = b._emscripten_bind_TessBaseAPI_GetDoubleVariable_2 =
          b.asm.Xc).apply(null, arguments)),
      kf = (b._emscripten_bind_TessBaseAPI_GetStringVariable_1 = () =>
        (kf = b._emscripten_bind_TessBaseAPI_GetStringVariable_1 =
          b.asm.Yc).apply(null, arguments)),
      lf = (b._emscripten_bind_TessBaseAPI_SaveParameters_1 = () =>
        (lf = b._emscripten_bind_TessBaseAPI_SaveParameters_1 = b.asm.Zc).apply(
          null,
          arguments
        )),
      mf = (b._emscripten_bind_TessBaseAPI_RestoreParameters_1 = () =>
        (mf = b._emscripten_bind_TessBaseAPI_RestoreParameters_1 =
          b.asm._c).apply(null, arguments)),
      nf = (b._emscripten_bind_TessBaseAPI_Init_2 = () =>
        (nf = b._emscripten_bind_TessBaseAPI_Init_2 = b.asm.$c).apply(
          null,
          arguments
        )),
      of = (b._emscripten_bind_TessBaseAPI_Init_3 = () =>
        (of = b._emscripten_bind_TessBaseAPI_Init_3 = b.asm.ad).apply(
          null,
          arguments
        )),
      pf = (b._emscripten_bind_TessBaseAPI_Init_4 = () =>
        (pf = b._emscripten_bind_TessBaseAPI_Init_4 = b.asm.bd).apply(
          null,
          arguments
        )),
      ...
      rf = (b._emscripten_bind_TessBaseAPI_InitForAnalysePage_0 = () =>
        (rf = b._emscripten_bind_TessBaseAPI_InitForAnalysePage_0 =
          b.asm.dd).apply(null, arguments)),
      sf = (b._emscripten_bind_TessBaseAPI_ReadConfigFile_1 = () =>
        (sf = b._emscripten_bind_TessBaseAPI_ReadConfigFile_1 = b.asm.ed).apply(
          null,
          arguments
        )),
      ...
      uf = (b._emscripten_bind_TessBaseAPI_SetPageSegMode_1 = () =>
        (uf = b._emscripten_bind_TessBaseAPI_SetPageSegMode_1 = b.asm.gd).apply(
          null,
          arguments
        )),
      vf = (b._emscripten_bind_TessBaseAPI_GetPageSegMode_0 = () =>
        (vf = b._emscripten_bind_TessBaseAPI_GetPageSegMode_0 = b.asm.hd).apply(
          null,
          arguments
        )),
      wf = (b._emscripten_bind_TessBaseAPI_TesseractRect_7 = () =>
        (wf = b._emscripten_bind_TessBaseAPI_TesseractRect_7 = b.asm.id).apply(
          null,
          arguments
        )),
      ...
      yf = (b._emscripten_bind_TessBaseAPI_SetImage_1 = () =>
        (yf = b._emscripten_bind_TessBaseAPI_SetImage_1 = b.asm.kd).apply(
          null,
          arguments
        )),
      zf = (b._emscripten_bind_TessBaseAPI_SetImage_5 = () =>
        (zf = b._emscripten_bind_TessBaseAPI_SetImage_5 = b.asm.ld).apply(
          null,
          arguments
        )),
      Af = (b._emscripten_bind_TessBaseAPI_SetImageFile_1 = () =>
        (Af = b._emscripten_bind_TessBaseAPI_SetImageFile_1 = b.asm.md).apply(
          null,
          arguments
        )),
      Bf = (b._emscripten_bind_TessBaseAPI_SetSourceResolution_1 = () =>
        (Bf = b._emscripten_bind_TessBaseAPI_SetSourceResolution_1 =
          b.asm.nd).apply(null, arguments)),
      Cf = (b._emscripten_bind_TessBaseAPI_SetRectangle_4 = () =>
        (Cf = b._emscripten_bind_TessBaseAPI_SetRectangle_4 = b.asm.od).apply(
          null,
          arguments
        )),
      Df = (b._emscripten_bind_TessBaseAPI_GetThresholdedImage_0 = () =>
        (Df = b._emscripten_bind_TessBaseAPI_GetThresholdedImage_0 =
          b.asm.pd).apply(null, arguments)),
      Ef = (b._emscripten_bind_TessBaseAPI_WriteImage_0 = () =>
        (Ef = b._emscripten_bind_TessBaseAPI_WriteImage_0 = b.asm.qd).apply(
          null,
          arguments
        )),
      Ff = (b._emscripten_bind_TessBaseAPI_FindLines_0 = () =>
        (Ff = b._emscripten_bind_TessBaseAPI_FindLines_0 = b.asm.rd).apply(
          null,
          arguments
        )),
      Gf = (b._emscripten_bind_TessBaseAPI_GetGradient_0 = () =>
        (Gf = b._emscripten_bind_TessBaseAPI_GetGradient_0 = b.asm.sd).apply(
          null,
          arguments
        )),
      Hf = (b._emscripten_bind_TessBaseAPI_GetRegions_1 = () =>
        (Hf = b._emscripten_bind_TessBaseAPI_GetRegions_1 = b.asm.td).apply(
          null,
          arguments
        )),
      If = (b._emscripten_bind_TessBaseAPI_GetTextlines_2 = () =>
        (If = b._emscripten_bind_TessBaseAPI_GetTextlines_2 = b.asm.ud).apply(
          null,
          arguments
        )),
      Jf = (b._emscripten_bind_TessBaseAPI_GetTextlines_5 = () =>
        (Jf = b._emscripten_bind_TessBaseAPI_GetTextlines_5 = b.asm.vd).apply(
          null,
          arguments
        )),
      Kf = (b._emscripten_bind_TessBaseAPI_GetStrips_2 = () =>
        (Kf = b._emscripten_bind_TessBaseAPI_GetStrips_2 = b.asm.wd).apply(
          null,
          arguments
        )),
      Lf = (b._emscripten_bind_TessBaseAPI_GetWords_1 = () =>
        (Lf = b._emscripten_bind_TessBaseAPI_GetWords_1 = b.asm.xd).apply(
          null,
          arguments
        )),
      ...
      Nf = (b._emscripten_bind_TessBaseAPI_GetComponentImages_4 = () =>
        (Nf = b._emscripten_bind_TessBaseAPI_GetComponentImages_4 =
      ...
      Qf = (b._emscripten_bind_TessBaseAPI_AnalyseLayout_0 = () =>
        (Qf = b._emscripten_bind_TessBaseAPI_AnalyseLayout_0 = b.asm.Cd).apply(
          null,
          arguments
        )),
      Rf = (b._emscripten_bind_TessBaseAPI_AnalyseLayout_1 = () =>
        (Rf = b._emscripten_bind_TessBaseAPI_AnalyseLayout_1 = b.asm.Dd).apply(
          null,
          arguments
        )),
      Sf = (b._emscripten_bind_TessBaseAPI_Recognize_1 = () =>
        (Sf = b._emscripten_bind_TessBaseAPI_Recognize_1 = b.asm.Ed).apply(
          null,
          arguments
        )),
      Tf = (b._emscripten_bind_TessBaseAPI_ProcessPages_4 = () =>
        (Tf = b._emscripten_bind_TessBaseAPI_ProcessPages_4 = b.asm.Fd).apply(
          null,
          arguments
        )),
      Uf = (b._emscripten_bind_TessBaseAPI_ProcessPage_6 = () =>
        (Uf = b._emscripten_bind_TessBaseAPI_ProcessPage_6 = b.asm.Gd).apply(
          null,
          arguments
        )),
      Vf = (b._emscripten_bind_TessBaseAPI_GetIterator_0 = () =>
        (Vf = b._emscripten_bind_TessBaseAPI_GetIterator_0 = b.asm.Hd).apply(
          null,
          arguments
        )),
      Wf = (b._emscripten_bind_TessBaseAPI_GetUTF8Text_0 = () =>
        (Wf = b._emscripten_bind_TessBaseAPI_GetUTF8Text_0 = b.asm.Id).apply(
          null,
          arguments
        )),
      Xf = (b._emscripten_bind_TessBaseAPI_GetHOCRText_1 = () =>
        (Xf = b._emscripten_bind_TessBaseAPI_GetHOCRText_1 = b.asm.Jd).apply(
          null,
          arguments
        )),
      Yf = (b._emscripten_bind_TessBaseAPI_GetTSVText_1 = () =>
        (Yf = b._emscripten_bind_TessBaseAPI_GetTSVText_1 = b.asm.Kd).apply(
          null,
          arguments
        )),
      Zf = (b._emscripten_bind_TessBaseAPI_GetBoxText_1 = () =>
        (Zf = b._emscripten_bind_TessBaseAPI_GetBoxText_1 = b.asm.Ld).apply(
          null,
          arguments
        )),
      $f = (b._emscripten_bind_TessBaseAPI_GetUNLVText_0 = () =>
        ($f = b._emscripten_bind_TessBaseAPI_GetUNLVText_0 = b.asm.Md).apply(
          null,
          arguments
        )),
      ag = (b._emscripten_bind_TessBaseAPI_GetOsdText_1 = () =>
        (ag = b._emscripten_bind_TessBaseAPI_GetOsdText_1 = b.asm.Nd).apply(
          null,
          arguments
        )),
      bg = (b._emscripten_bind_TessBaseAPI_MeanTextConf_0 = () =>
        (bg = b._emscripten_bind_TessBaseAPI_MeanTextConf_0 = b.asm.Od).apply(
          null,
          arguments
        )),
      cg = (b._emscripten_bind_TessBaseAPI_AllWordConfidences_0 = () =>
        (cg = b._emscripten_bind_TessBaseAPI_AllWordConfidences_0 =
          b.asm.Pd).apply(null, arguments)),
      dg = (b._emscripten_bind_TessBaseAPI_Clear_0 = () =>
        (dg = b._emscripten_bind_TessBaseAPI_Clear_0 = b.asm.Qd).apply(
          null,
          arguments
        )),
      eg = (b._emscripten_bind_TessBaseAPI_End_0 = () =>
        (eg = b._emscripten_bind_TessBaseAPI_End_0 = b.asm.Rd).apply(
          null,
          arguments
        )),
      fg = (b._emscripten_bind_TessBaseAPI_ClearPersistentCache_0 = () =>
        (fg = b._emscripten_bind_TessBaseAPI_ClearPersistentCache_0 =
          b.asm.Sd).apply(null, arguments)),
      gg = (b._emscripten_bind_TessBaseAPI_IsValidWord_1 = () =>
        (gg = b._emscripten_bind_TessBaseAPI_IsValidWord_1 = b.asm.Td).apply(
          null,
          arguments
        )),
      hg = (b._emscripten_bind_TessBaseAPI_IsValidCharacter_1 = () =>
        (hg = b._emscripten_bind_TessBaseAPI_IsValidCharacter_1 =
          b.asm.Ud).apply(null, arguments)),
      ig = (b._emscripten_bind_TessBaseAPI_DetectOS_1 = () =>
        (ig = b._emscripten_bind_TessBaseAPI_DetectOS_1 = b.asm.Vd).apply(
          null,
          arguments
        )),
      jg = (b._emscripten_bind_TessBaseAPI_GetUnichar_1 = () =>
        (jg = b._emscripten_bind_TessBaseAPI_GetUnichar_1 = b.asm.Wd).apply(
          null,
          arguments
        )),
      kg = (b._emscripten_bind_TessBaseAPI_GetDawg_1 = () =>
        (kg = b._emscripten_bind_TessBaseAPI_GetDawg_1 = b.asm.Xd).apply(
          null,
          arguments
        )),
      lg = (b._emscripten_bind_TessBaseAPI_NumDawgs_0 = () =>
        (lg = b._emscripten_bind_TessBaseAPI_NumDawgs_0 = b.asm.Yd).apply(
          null,
          arguments
        )),
      mg = (b._emscripten_bind_TessBaseAPI_oem_0 = () =>
        (mg = b._emscripten_bind_TessBaseAPI_oem_0 = b.asm.Zd).apply(
          null,
          arguments
        )),
      ng = (b._emscripten_bind_TessBaseAPI___destroy___0 = () =>
        (ng = b._emscripten_bind_TessBaseAPI___destroy___0 = b.asm._d).apply(
          null,
          arguments
        )),
      og = (b._emscripten_bind_OSResults_OSResults_0 = () =>
        (og = b._emscripten_bind_OSResults_OSResults_0 = b.asm.$d).apply(
          null,
          arguments
        )),
      pg = (b._emscripten_bind_OSResults_print_scores_0 = () =>
        (pg = b._emscripten_bind_OSResults_print_scores_0 = b.asm.ae).apply(
          null,
          arguments
        )),
      qg = (b._emscripten_bind_OSResults_get_best_result_0 = () =>
        (qg = b._emscripten_bind_OSResults_get_best_result_0 = b.asm.be).apply(
          null,
          arguments
        )),
      rg = (b._emscripten_bind_OSResults_get_unicharset_0 = () =>
        (rg = b._emscripten_bind_OSResults_get_unicharset_0 = b.asm.ce).apply(
          null,
          arguments
        )),
      sg = (b._emscripten_bind_OSResults___destroy___0 = () =>
        (sg = b._emscripten_bind_OSResults___destroy___0 = b.asm.de).apply(
          null,
          arguments
        )),
      tg = (b._emscripten_bind_Pixa_get_n_0 = () =>
        (tg = b._emscripten_bind_Pixa_get_n_0 = b.asm.ee).apply(
          null,
          arguments
        )),
      ug = (b._emscripten_bind_Pixa_get_nalloc_0 = () =>
        (ug = b._emscripten_bind_Pixa_get_nalloc_0 = b.asm.fe).apply(
          null,
          arguments
        )),
      vg = (b._emscripten_bind_Pixa_get_refcount_0 = () =>
        (vg = b._emscripten_bind_Pixa_get_refcount_0 = b.asm.ge).apply(
          null,
          arguments
        )),
      wg = (b._emscripten_bind_Pixa_get_pix_0 = () =>
        (wg = b._emscripten_bind_Pixa_get_pix_0 = b.asm.he).apply(
          null,
          arguments
        )),
      xg = (b._emscripten_bind_Pixa_get_boxa_0 = () =>
        (xg = b._emscripten_bind_Pixa_get_boxa_0 = b.asm.ie).apply(
          null,
          arguments
        )),
      yg = (b._emscripten_bind_Pixa___destroy___0 = () =>
        (yg = b._emscripten_bind_Pixa___destroy___0 = b.asm.je).apply(
          null,
          arguments
        )),
      zg = (b._emscripten_enum_PageIteratorLevel_RIL_BLOCK = () =>
        (zg = b._emscripten_enum_PageIteratorLevel_RIL_BLOCK = b.asm.ke).apply(
          null,
          arguments
        )),
      Ag = (b._emscripten_enum_PageIteratorLevel_RIL_PARA = () =>
        (Ag = b._emscripten_enum_PageIteratorLevel_RIL_PARA = b.asm.le).apply(
          null,
          arguments
        )),
      ...
      Cg = (b._emscripten_enum_PageIteratorLevel_RIL_WORD = () =>
        (Cg = b._emscripten_enum_PageIteratorLevel_RIL_WORD = b.asm.ne).apply(
          null,
          arguments
        )),
      Dg = (b._emscripten_enum_PageIteratorLevel_RIL_SYMBOL = () =>
        (Dg = b._emscripten_enum_PageIteratorLevel_RIL_SYMBOL = b.asm.oe).apply(
          null,
          arguments
        )),
      ...
      Fg = (b._emscripten_enum_OcrEngineMode_OEM_LSTM_ONLY = () =>
        (Fg = b._emscripten_enum_OcrEngineMode_OEM_LSTM_ONLY = b.asm.qe).apply(
          null,
          arguments
        )),
      ...
      Hg = (b._emscripten_enum_OcrEngineMode_OEM_DEFAULT = () =>
        (Hg = b._emscripten_enum_OcrEngineMode_OEM_DEFAULT = b.asm.se).apply(
          null,
          arguments
        )),
      Ig = (b._emscripten_enum_OcrEngineMode_OEM_COUNT = () =>
        (Ig = b._emscripten_enum_OcrEngineMode_OEM_COUNT = b.asm.te).apply(
          null,
          arguments
        )),
      Jg =
      ...
      Mg = (b._emscripten_enum_PolyBlockType_PT_UNKNOWN = () =>
        (Mg = b._emscripten_enum_PolyBlockType_PT_UNKNOWN = b.asm.xe).apply(
          null,
          arguments
        )),
      Ng = (b._emscripten_enum_PolyBlockType_PT_FLOWING_TEXT = () =>
        (Ng = b._emscripten_enum_PolyBlockType_PT_FLOWING_TEXT =
      ...
      Qg = (b._emscripten_enum_PolyBlockType_PT_EQUATION = () =>
        (Qg = b._emscripten_enum_PolyBlockType_PT_EQUATION = b.asm.Be).apply(
          null,
          arguments
        )),
      ...
      Sg = (b._emscripten_enum_PolyBlockType_PT_TABLE = () =>
        (Sg = b._emscripten_enum_PolyBlockType_PT_TABLE = b.asm.De).apply(
          null,
          arguments
        )),
      ...
      Ug = (b._emscripten_enum_PolyBlockType_PT_CAPTION_TEXT = () =>
        (Ug = b._emscripten_enum_PolyBlockType_PT_CAPTION_TEXT =
          b.asm.Fe).apply(null, arguments)),
      Vg = (b._emscripten_enum_PolyBlockType_PT_FLOWING_IMAGE = () =>
        (Vg = b._emscripten_enum_PolyBlockType_PT_FLOWING_IMAGE =
          b.asm.Ge).apply(null, arguments)),
      Wg = (b._emscripten_enum_PolyBlockType_PT_HEADING_IMAGE = () =>
        (Wg = b._emscripten_enum_PolyBlockType_PT_HEADING_IMAGE =
          b.asm.He).apply(null, arguments)),
      Xg = (b._emscripten_enum_PolyBlockType_PT_PULLOUT_IMAGE = () =>
        (Xg = b._emscripten_enum_PolyBlockType_PT_PULLOUT_IMAGE =
          b.asm.Ie).apply(null, arguments)),
      Yg = (b._emscripten_enum_PolyBlockType_PT_HORZ_LINE = () =>
        (Yg = b._emscripten_enum_PolyBlockType_PT_HORZ_LINE = b.asm.Je).apply(
          null,
          arguments
        )),
      Zg = (b._emscripten_enum_PolyBlockType_PT_VERT_LINE = () =>
        (Zg = b._emscripten_enum_PolyBlockType_PT_VERT_LINE = b.asm.Ke).apply(
          null,
          arguments
        )),
      $g = (b._emscripten_enum_PolyBlockType_PT_NOISE = () =>
        ($g = b._emscripten_enum_PolyBlockType_PT_NOISE = b.asm.Le).apply(
          null,
          arguments
        )),
      ah = (b._emscripten_enum_PolyBlockType_PT_COUNT = () =>
        (ah = b._emscripten_enum_PolyBlockType_PT_COUNT = b.asm.Me).apply(
          null,
          arguments
        )),
      ...
      ch = (b._emscripten_enum_StrongScriptDirection_DIR_LEFT_TO_RIGHT = () =>
        (ch = b._emscripten_enum_StrongScriptDirection_DIR_LEFT_TO_RIGHT =
          b.asm.Oe).apply(null, arguments)),
      dh = (b._emscripten_enum_StrongScriptDirection_DIR_RIGHT_TO_LEFT = () =>
        (dh = b._emscripten_enum_StrongScriptDirection_DIR_RIGHT_TO_LEFT =
          b.asm.Pe).apply(null, arguments)),
      eh = (b._emscripten_enum_StrongScriptDirection_DIR_MIX = () =>
        (eh = b._emscripten_enum_StrongScriptDirection_DIR_MIX =
      ...
      mh = (b._emscripten_enum_Orientation__ORIENTATION_PAGE_UP = () =>
        (mh = b._emscripten_enum_Orientation__ORIENTATION_PAGE_UP =
          b.asm.Ye).apply(null, arguments)),
      nh = (b._emscripten_enum_Orientation__ORIENTATION_PAGE_RIGHT = () =>
        (nh = b._emscripten_enum_Orientation__ORIENTATION_PAGE_RIGHT =
          b.asm.Ze).apply(null, arguments)),
      oh = (b._emscripten_enum_Orientation__ORIENTATION_PAGE_DOWN = () =>
        (oh = b._emscripten_enum_Orientation__ORIENTATION_PAGE_DOWN =
          b.asm._e).apply(null, arguments)),
      ph = (b._emscripten_enum_Orientation__ORIENTATION_PAGE_LEFT = () =>
        (ph = b._emscripten_enum_Orientation__ORIENTATION_PAGE_LEFT =
          b.asm.$e).apply(null, arguments)),
      qh = (b._emscripten_enum_PageSegMode_PSM_OSD_ONLY = () =>
        (qh = b._emscripten_enum_PageSegMode_PSM_OSD_ONLY = b.asm.af).apply(
          null,
          arguments
        )),
      rh = (b._emscripten_enum_PageSegMode_PSM_AUTO_OSD = () =>
        (rh = b._emscripten_enum_PageSegMode_PSM_AUTO_OSD = b.asm.bf).apply(
          null,
          arguments
        )),
      sh = (b._emscripten_enum_PageSegMode_PSM_AUTO_ONLY = () =>
        (sh = b._emscripten_enum_PageSegMode_PSM_AUTO_ONLY = b.asm.cf).apply(
          null,
          arguments
        )),
      th = (b._emscripten_enum_PageSegMode_PSM_AUTO = () =>
        (th = b._emscripten_enum_PageSegMode_PSM_AUTO = b.asm.df).apply(
          null,
          arguments
        )),
      uh = (b._emscripten_enum_PageSegMode_PSM_SINGLE_COLUMN = () =>
        (uh = b._emscripten_enum_PageSegMode_PSM_SINGLE_COLUMN =
      ...
      wh = (b._emscripten_enum_PageSegMode_PSM_SINGLE_BLOCK = () =>
        (wh = b._emscripten_enum_PageSegMode_PSM_SINGLE_BLOCK = b.asm.gf).apply(
          null,
          arguments
        )),
      xh = (b._emscripten_enum_PageSegMode_PSM_SINGLE_LINE = () =>
        (xh = b._emscripten_enum_PageSegMode_PSM_SINGLE_LINE = b.asm.hf).apply(
          null,
          arguments
        )),
      yh = (b._emscripten_enum_PageSegMode_PSM_SINGLE_WORD = () =>
        (yh = b._emscripten_enum_PageSegMode_PSM_SINGLE_WORD = b.asm.jf).apply(
          null,
          arguments
        )),
      zh = (b._emscripten_enum_PageSegMode_PSM_CIRCLE_WORD = () =>
        (zh = b._emscripten_enum_PageSegMode_PSM_CIRCLE_WORD = b.asm.kf).apply(
          null,
          arguments
        )),
      Ah = (b._emscripten_enum_PageSegMode_PSM_SINGLE_CHAR = () =>
        (Ah = b._emscripten_enum_PageSegMode_PSM_SINGLE_CHAR = b.asm.lf).apply(
          null,
          arguments
        )),
      Bh = (b._emscripten_enum_PageSegMode_PSM_SPARSE_TEXT = () =>
        (Bh = b._emscripten_enum_PageSegMode_PSM_SPARSE_TEXT = b.asm.mf).apply(
          null,
          arguments
        )),
      ...
      Dh = (b._emscripten_enum_PageSegMode_PSM_RAW_LINE = () =>
        (Dh = b._emscripten_enum_PageSegMode_PSM_RAW_LINE = b.asm.of).apply(
          null,
          arguments
        )),
      Eh = (b._emscripten_enum_PageSegMode_PSM_COUNT = () =>
        (Eh = b._emscripten_enum_PageSegMode_PSM_COUNT = b.asm.pf).apply(
          null,
          arguments
        ))
    b._pixDestroy = () => (b._pixDestroy = b.asm.rf).apply(null, arguments)
    b._ptaDestroy = () => (b._ptaDestroy = b.asm.sf).apply(null, arguments)
    b._pixaDestroy = () => (b._pixaDestroy = b.asm.tf).apply(null, arguments)
    b._boxaDestroy = () => (b._boxaDestroy = b.asm.uf).apply(null, arguments)
    b._pixReadMem = () => (b._pixReadMem = b.asm.vf).apply(null, arguments)
    function Rb() {
      return (Rb = b.asm.wf).apply(null, arguments)
    }
    var Fh = (b._free = () => (Fh = b._free = b.asm.xf).apply(null, arguments)),
      Fb = (b._malloc = () =>
        (Fb = b._malloc = b.asm.yf).apply(null, arguments))
    b._pixReadHeaderMem = () =>
      (b._pixReadHeaderMem = b.asm.zf).apply(null, arguments)
    function C() {
