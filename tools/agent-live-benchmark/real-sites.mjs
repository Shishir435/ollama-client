...
const cases = [
  [
    "wiki_read",
    "What year was Chromium first released? Report the year.",
    "https://en.wikipedia.org/wiki/Chromium_(web_browser)",
    "2008"
  ],
  [
    "hn_top",
    "Report the exact title of the top story on this page.",
    "https://news.ycombinator.com/",
    "__inbody__"
  ],
  [
    "gh_about",
    "Report the repository description shown in the About section.",
    "https://github.com/Shishir435/ollama-client",
    "__inbody__"
  ],
  [
    "wiki_search",
    "Use the search box to find the Wikipedia article about Firefox, then report the title of the article you landed on.",
